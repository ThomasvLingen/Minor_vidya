...
namespace GameLogic {
    ...
    enum class Action {
        MOVE_FORWARD, MOVE_BACKWARD, MOVE_LEFT, MOVE_RIGHT, ROTATE_LEFT, ROTATE_RIGHT, ACTION_INTERACT, ACTION_USE, MENU_UP, MENU_DOWN, MENU_SELECT, MENU_BACK, PAUSE_GAME, ACTION_HURT, ACTION_SHOOT, ACTION_MELEE, ACTION_NEXTWEAPON, ACTION_PREVIOUSWEAPON
    };
