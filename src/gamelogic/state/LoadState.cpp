...
namespace State {
    ...
    void LoadState::update(int time_since_last_update) {
        ...
        if (this->_loading_screen_time < 150) {
            ...
            this->_context.SDL_facade.draw_image("res/loading_bar/loading_bar_1.bmp", {220, 220});
            ...
            this->_context.SDL_facade.draw_text("Loading...", FontType::alterebro_pixel_plus, this->_color, {255,150});
            this->_context.SDL_facade.draw_image("res/loading_bar/loading_bar_2.bmp", {220, 220});
            ...
            this->_context.SDL_facade.draw_text("Loading...", FontType::alterebro_pixel_plus, this->_color, {255,150});
            this->_context.SDL_facade.draw_image("res/loading_bar/loading_bar_3.bmp", {220, 220});
            ...
            this->_context.SDL_facade.draw_text("Loading...", FontType::alterebro_pixel_plus, this->_color, {255,150});
            this->_context.SDL_facade.draw_image("res/loading_bar/loading_bar_4.bmp", {220, 220});
            ...
            this->_context.SDL_facade.draw_text("Loading...", FontType::alterebro_pixel_plus, this->_color, {255,150});
            this->_context.SDL_facade.draw_image("res/loading_bar/loading_bar_5.bmp", {220, 220});
            ...
            this->_context.SDL_facade.draw_text("Loading...", FontType::alterebro_pixel_plus, this->_color, {255,150});
            this->_context.SDL_facade.draw_image("res/loading_bar/loading_bar_6.bmp", {220, 220});
            ...
            this->_context.SDL_facade.draw_text("Loading...", FontType::alterebro_pixel_plus, this->_color, {255,150});
            this->_context.SDL_facade.draw_image("res/loading_bar/loading_bar_7.bmp", {220, 220});
            ...
            this->_context.SDL_facade.draw_text("Loading...", FontType::alterebro_pixel_plus, this->_color, {255,150});
            this->_context.SDL_facade.draw_image("res/loading_bar/loading_bar_8.bmp", {220, 220});
